  ...
  const courses = [
    {
      ...
      tabs: [
        ...
        },
        {
          ...
          options: [
            { name: 'Twin-Sharing Room', priceMode: 'base' as const, addOn: 0, image: room1, description: 'Two single beds, shared en-suite bathroom.' },
            { name: 'Private Room', priceMode: 'addon' as const, addOn: 3500, image: room2, description: 'Your own room with en-suite bathroom and garden view.' },
            { name: 'Garden Cottage', priceMode: 'addon' as const, addOn: 6000, image: room3, description: 'A standalone cottage for complete quiet and privacy.' },
          ],
        },
        {
