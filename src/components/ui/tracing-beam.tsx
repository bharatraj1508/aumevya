...
export const TracingBeam = ({
  ...
  return (
    <motion.div ref={ref} className={cn('relative mx-auto h-full w-full max-w-4xl', className)}>
      <div className="pointer-events-none absolute top-3 left-2 z-40 md:left-6">
        <motion.div
        ...
        >
          <motion.div
            transition={{ duration: 0.2, delay: 0.5 }}
            animate={{
              backgroundColor: scrollYProgress.get() > 0 ? 'white' : '#3a86ff',
              borderColor: scrollYProgress.get() > 0 ? 'white' : '#2f6fe0',
            }}
        ...
        >
          ...
          <defs>
            ...
            >
              ...
              <stop offset="0.325" stopColor="#3a86ff"></stop>
