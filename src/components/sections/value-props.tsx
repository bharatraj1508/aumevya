      ...
      <div className="container-page">
        <StaggerGroup className="grid gap-6 md:grid-cols-3">
          {PROPS.map(({ icon: Icon, title, body }) => (
            <StaggerItem
              key={title}
              className="group rounded-2xl border border-gray-200 bg-gray-50/85 p-7 backdrop-blur-xl transition-all duration-300 [box-shadow:0_1px_1px_rgba(0,0,0,0.03),0_12px_32px_-14px_rgba(0,0,0,0.22),inset_0_1px_0_rgba(255,255,255,0.75)] hover:-translate-y-1.5 hover:[box-shadow:0_1px_1px_rgba(0,0,0,0.04),0_26px_54px_-18px_rgba(0,0,0,0.30),inset_0_1px_0_rgba(255,255,255,0.9)] supports-[backdrop-filter]:bg-gray-50/75"
            >
